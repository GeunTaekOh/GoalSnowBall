...
public class GoalDataSet {
    ...
    public String getTypeToday(){return this.typeToday;}
    public int getAmountToday(){return this.amountToday;}
    public int getUnitToday(){return this.unitToday;}

    public String getTypeWeek(){return this.typeWeek;}
    public int getAmountWeek(){return this.amountWeek;}
    public int getUnitWeek(){return this.unitWeek;}

    public String getTypeMonth(){return this.typeMonth;}
    public int getAmountMonth(){return this.amountMonth;}
    public int getUnitMonth(){return this.unitMonth;}
}
